...
//  out.println("<br><br>");
   ...
   controlmsisdn = request.getParameter("controlmsisdn");
    ...
    String[] destination_media =  new String[pagesize];
...
for (int i=0; i < pagesize;i++)
{
   ...
   destination_media[i] = request.getParameter("destination_media"+ Integer.toString(i+theoffset));
  ...
  if(ischeck[i] != null)
  {
   ...
   try{
         ...
         else
         {
			 ...
			 if (destination_media[i].equalsIgnoreCase("2"))
			 {
				con.createStatement().execute("insert into chatarabic2(msisdn,messagecontents,country) values ('" + tel[i] + "', N'" + msg[i] + "',N'" + country[i]+ "')" );         
			 }
			 else
			 {
				con.createStatement().execute("insert into chatarabic(msisdn,messagecontents,country) values ('" + tel[i] + "', N'" + msg[i] + "',N'" + country[i]+ "')" );         
			 }
          ...
          {
			con.createStatement().execute("insert into chatarabic(msisdn,messagecontents,country) values ('" + controlmsisdn + "', N'" + msgcontrol[i] + "',N'" + country[i]+ "')" );                   
          }
