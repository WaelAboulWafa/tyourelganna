...
//-----------------------------------
String query1 = "SELECT count(*) from UpperInfo";
String query2 = "SELECT ID from UpperInfo order by ID";
String query3 = "select ID, TheText, Selected from UpperInfo order by ID";
...
{
if(target == 0) {document.thisfrm.action="upperInfoBATCHUpdate.jsp";document.thisfrm.submit();}
if(target == 1) {document.thisfrm.action="upperInfoBATCHdelete.jsp";document.thisfrm.submit();}
}
...
<title> ‰ÊÌÂ«  2 ... <%=(new String(medianame.getBytes("Cp1252"),"Cp1256"))%></title>
  ...
  <tr>
    ...
    <td width='19%' align='center'>
    	<table border='0' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%'>
 		...
 		<form name='theform' action='upperinfo.jsp' method='post'>
...
<br>
 <br>
            ...
            <table border='1' bgcolor=#DCDCDC align='center' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#AAAAAA' width='50%'>
                    <form action='newupperinfo.jsp' method='post'>
                                 <tr>
...
%>
            ...
            <td align='center'>  <TEXTAREA dir="RTL" style="FONT-WEIGHT: bold; FONT-SIZE: 12pt" NAME=msg<%= l %>  COLS=65 ROWS=2 ><%= (new String(msg[l].getBytes("Cp1252"),"Cp1256")) %></TEXTAREA></td>    	    
<%
