...
%>
   <tr>
        <td align='center'><font color='#000000' face='Arial' size='3'><%=(new String(Us[r][0].getBytes("Cp1252"),"Cp1256"))%></font></td>
        <td align='center'><font color='#000000' face='Arial' size='3'><%=(new String(Us[r][1].getBytes("Cp1252"),"Cp1256"))%></font></td>
        <td align='center'><font color='#000000' face='Arial' size='3'><%=(new String(Us[r][2].getBytes("Cp1252"),"Cp1256"))%></font></td>
        <td align='center'><font color='#000000' face='Arial' size='3'><%=(new String(Us[r][3].getBytes("Cp1252"),"Cp1256"))%></font></td>
        <td align='center'><font color='#000000' face='Arial' size='3'><%=(new String(Us[r][4].getBytes("Cp1252"),"Cp1256"))%></font></td>
   </tr>
<%
}
%>
