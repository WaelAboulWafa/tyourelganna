...
<title>—”«∆· ⁄·Ï «·‘«‘… ... <%=(new String(medianame.getBytes("Cp1252"),"Cp1256"))%></title>
...
function poetrycorrectinvoke(target)
{
...
<table border='1' bgcolor=#DCDCDC cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%' height='80'>
  <tr>
    <td width='21%' align='center'><b><i><font color='#A36103' size='6'>—”«∆· ⁄·Ï «·‘«‘…</font></i></b></td>
...
%>
    	    ...
    	    <td width='20%' align='center'><b> <%= (new String(nickname1[l].getBytes("Cp1252"),"Cp1256")) %> </b></td>    	    
            <td width='70%' align='center'><b>  <TEXTAREA dir="RTL" style="FONT-WEIGHT: bold; FONT-SIZE: 12pt" NAME=msg1_<%= l %>  COLS=65 ROWS=2 ><%= (new String(messagecontents1[l].getBytes("Cp1252"),"Cp1256")) %></TEXTAREA></b></td>    	    
