...
//   if(thepage[k].equalsIgnoreCase("upperinfo.jsp")){if(allowed[k] == 1){allowedaccess =true;}}
   if(thepage[k].equalsIgnoreCase("info3.jsp")){if(allowed[k] == 1){allowedaccess =true;}}
...
//-----------------------------------
String query1 = "SELECT count(*) from info3";
String query2 = "SELECT ID from info3 order by ID";
String query3 = "select ID, TheText, Selected from info3 order by ID";
...
{
if(target == 0) {document.thisfrm.action="info3batchupdate.jsp";document.thisfrm.submit();}
if(target == 1) {document.thisfrm.action="info3batchdelete.jsp";document.thisfrm.submit();}
}
...
<table border='1' bgcolor=#DCDCDC cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%' height='80'>
  <tr>
    <td width='21%' align='center'><b><i><font color='#A36103' size='6'> ‰ÊÌÂ«  3</font></i></b></td>
    ...
    <td width='19%' align='center'>
    	<table border='0' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%'>
 		...
 		<form name='theform' action='info3.jsp' method='post'>
...
<br>
 <br>
            ...
            <table border='1' bgcolor=#DCDCDC align='center' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#AAAAAA' width='50%'>
                    <form action='info3new.jsp' method='post'>
                                 <tr>
