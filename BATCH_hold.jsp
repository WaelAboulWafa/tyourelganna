...
for (int i =0;i< pagesize ;i ++)
{
  if(ischeck[i] != null)
  {
   ...
   try{
         if (hold_userid[i].equalsIgnoreCase("0") || hold_userid[i].equalsIgnoreCase(userid) )
         {
          con.createStatement().execute("update NewSMS set hold=" + userid+ " where originalid=" + id[i]);          
         }
