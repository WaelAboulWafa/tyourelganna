...
{
 rs=null;
 rs = con.prepareStatement("insert into  Users( username, password, description) values(N'"+ request.getParameter("uname") + "',N'"+ request.getParameter("pword") +"',N'" + request.getParameter("oname") + "')  select @@IDENTITY" ).executeQuery();  
 int theID = 0;            
...
thepassword = new String[theuserscount];
...
//         try{thepassword[theCounterrr1] = Validator.getpwd(Integer.parseInt(theuserid[theCounterrr1]));}catch(Exception e){thepassword[theCounterrr1] ="";}
         thepassword[theCounterrr1] = "";
...
<title>„” Œœ„Ì‰ ... <%=(new String(medianame.getBytes("Cp1252"),"Cp1256"))%></title>
</head>
...
{
%>			        
			 <input disabled type='radio'   name='iplist' value='any'><font size='3'>&nbsp;«Ì „ﬂ«‰</font>
			 <input disabled type='radio' checked name='iplist' value='list'><font size='3'>&nbsp;„Ã„Ê⁄… IP</font>
<%
}
else
{
