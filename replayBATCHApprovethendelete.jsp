...
for (int i =0;i< pagesize ;i ++)
{
  if(ischeck[i] != null)
  {
   try{
          ...
          con.createStatement().execute("insert into chatarabic(msisdn,messagecontents) values ('" + tel[i] + "', N'" + msg[i] + "')" );
          con.createStatement().execute("delete from chatReplay where id=" + id[i]); 
