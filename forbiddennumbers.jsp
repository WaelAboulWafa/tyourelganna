...
{
 rs = con.createStatement().executeQuery("select count(*) from ForbiddenNumbers");            
}
...
{
if(target == 0) {document.thisfrm.action="addforbidden.jsp";document.thisfrm.submit();}
...
if(whattocall == 0) {document.thethisfrm.action="thebatchsubmodify.jsp";document.thethisfrm.submit();}
if(whattocall == 1) {document.thethisfrm.action="thebatchsubdelete.jsp";document.thethisfrm.submit();}
...
<table border='1' bgcolor=#DCDCDC cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%' height='80'>
  <tr>
    <td width='21%' align='center'><b><i><font color='#A36103' size='6'>«·«—ﬁ«„ «·„ÕŸÊ—Â</font></i></b></td>
    ...
    <td width='19%' align='center'>
    	<table border='0' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%'>
 		...
 		<form name='theform' action='forbiddennumbers.jsp' method='post'>
          ...
          <td width='100%' height='369' valign='top'>
      	    <table border='0' align='center' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#ffffff' width='30%'>
      	      ...
      	      <tr height='25' bgcolor=#DCDCDC>
      	        ...
      	        <td width='100%' colspan=2 align='center'><b>«·—ﬁ„</b></td>
      	      ...
      	      <tr >
      	        ...
      	        <td width='75%' align='center'><input type='text' style='font-size:12pt;color:#000000;font-weight:bold;width:15em;height:1.7em' dir='ltr' name='country' ></td>

      	        


      	        <td width='25%' align='right'><input type='button' name='subAdd' value='«÷«›…' style='font-weight:bold ; width:7em ; height:2.5em' onClick="correctinvoke(0)"></td>
...
<tr height='25' bgcolor=#DCDCDC>
 ...
 <td align='center'><b>⁄œœ</b>&nbsp;&nbsp;&nbsp;&nbsp;<font color=#000099><b><%= count %></b></font></td>
     ...
     <table border='1' align='center' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#cccccc' width='30%'>
        	      ...
        	      <td width='29%' align='center'><b>—ﬁ„</b></td>
...
if (filtertheprovider.equalsIgnoreCase("ALL"))  
{   
   rs = con.createStatement().executeQuery("SELECT     id, msisdn FROM         ForbiddenNumbers ORDER BY id");  
}
...
%>
 ...
 <td width='10%' align='center'><INPUT dir='ltr' style='font-size:12pt;color:#000000;font-weight:bold;width:16em;height:1.7em' NAME=thecountry<%= therownnum %> value='<%=thecountry%>' ></td>
