...
String query1 = "SELECT count(*) from chatArabic2";
String  query2 = "select chatArabic2.AiringID,chatArabic2.msisdn,        (case when chatNickNames.MessageContents is not null then  chatNickNames.MessageContents else '' end )AS NickName ,                 chatArabic2.MessageContents,chatArabic2.senttoair FROM     chatArabic2 LEFT OUTER JOIN      chatNickNames ON chatArabic2.MSISDN = chatNickNames.MSISDN order by  chatArabic2.AiringID";    
...
{
if(target == 0) {document.thisfrm1.action="smsonair2modify.jsp";document.thisfrm1.submit();}
if(target == 1) {document.thisfrm1.action="smsonair2delete.jsp";document.thisfrm1.submit();}
}
...
<table border='1' bgcolor=#DCDCDC cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%' height='80'>
  <tr>
    <td width='21%' align='center'><b><i><font color='#A36103' size='6'>—”«∆· ⁄·Ì «·‘«‘Â 2</font></i></b></td>
    ...
    <td width='19%' align='center'>
    	<table border='0' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%'>
 		...
 		<form name='theform' action='smsonair2.jsp' method='post'>
