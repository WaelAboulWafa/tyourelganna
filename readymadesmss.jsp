...
//   if(thepage[k].equalsIgnoreCase("upperinfo.jsp")){if(allowed[k] == 1){allowedaccess =true;}}
   if(thepage[k].equalsIgnoreCase("readymadesmss.jsp")){if(allowed[k] == 1){allowedaccess =true;}}
...
//-----------------------------------
String query1 = "SELECT count(*) from readymadesmss where theuserid=" + userid;
String query2 = "SELECT ID from readymadesmss where theuserid=" + userid + " order by ID";
String query3 = "select ID, TheText from readymadesmss where theuserid=" + userid + " order by ID";
...
{
if(target == 0) {document.thisfrm.action="readymadesmssbatchupdate.jsp";document.thisfrm.submit();}
if(target == 1) {document.thisfrm.action="readymadesmssbatchdelete.jsp";document.thisfrm.submit();}
if(target == 2) {document.thisfrm.action="readymadesmssbatchsend.jsp";document.thisfrm.submit();}
}
...
<table border='1' bgcolor=#DCDCDC cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%' height='80'>
  <tr>
    <td width='21%' align='center'><b><i><font color='#A36103' size='6'>—”«∆· Ã«Â“Â</font></i></b></td>
    ...
    <td width='19%' align='center'>
    	<table border='0' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#A36103' width='100%'>
 		...
 		<form name='theform' action='readymadesmss.jsp' method='post'>
...
<br>
 <br>
            ...
            <table border='1' bgcolor=#DCDCDC align='center' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#AAAAAA' width='50%'>
                    <form action='readymadesmssnew.jsp' method='post'>
                        ...
                        <td>
                              <table border='0' align='center' bgcolor=#DCDCDC cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#111111' width='100%'>
                                    <tr>
                                          ...
                                          <td width='10%' align='center'><input type='submit' name='subApproveSMSSel' value=' ⁄œÌ·' style='font-weight:bold ; width:11em ; height:2em' onClick="correctinvoke(0)"></td>
                                          <td width='10%' align='center'><input type='submit' name='subDeclineSMSSel' value='Õ–›' style='font-weight:bold ; width:11em ; height:2em'  onClick="correctinvoke(1)"></td>
 					                      <td width='10%' align='center'><input type='submit' name='subDeclineSMSSel' value='«—”«·' style='font-weight:bold ; color:#AA0000; font-size:12pt ; width:12em ; height:2em'  onClick="correctinvoke(2)"></td>
	 ...
	 <form name=thisfrm method=post action="" >
            ...
            <table border='1' align='center' bgcolor=#DCDCDC cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#111111' width='90%'>
                ...
                <td width='15%' height='30' align='center'><b><font size='3'>«”„ „” ⁄«—</font></b></td>
                <td width='15%' height='30' align='center'>
                 <select name='themsisdn' style='font-size:11pt;font-weight:bold;width:15em;height:2em'>
...
%>
                 ...
                 <td  width='15%' align='center'  colspan='2'><INPUT NAME=nickchecked TYPE=CHECKBOX " ><b><font size='3'>»œÊ‰ «”„ „” ⁄«—</font></b></td>
     ...
     <table border='1' align='center' cellpadding='0' cellspacing='0' style='border-collapse: collapse' bordercolor='#cccccc' width='90%'>
...
%>
		<tr bgcolor=#EEEEEE> 
            ...
            <td align='center'>  <TEXTAREA dir="RTL" style="FONT-WEIGHT: bold; FONT-SIZE: 12pt" NAME=msg<%= l %>  COLS=85 ROWS=2 ><%=  msg[l]  %></TEXTAREA></td>    	    
