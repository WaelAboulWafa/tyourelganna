...
try{
   ...
   ResultSet  rs = con.createStatement().executeQuery("SELECT count(*) as thecnt from ForbiddenNumbers where msisdn='"+ country + "'");             
   int found = 0;
   ...
   rs.close();rs = null;
    ...
    {   
      con.createStatement().execute("insert into  ForbiddenNumbers( msisdn) values(N'"+ country + "')"); 
      con.close();  
...
}catch(Exception e){response.sendRedirect("forbiddennumbers.jsp");}
